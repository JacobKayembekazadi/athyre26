          ...
          {COLLECTION_CARDS.map((card, idx) => (
            <div key={idx} className="group relative aspect-[3/4] overflow-hidden bg-gray-100 cursor-pointer">
              ...
              <div className="absolute inset-x-8 bottom-12 text-white">
                ...
                <Link to="/collection/rise" className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.2em] border-b-2 border-white pb-1 group-hover:gap-4 transition-all">Explore</Link>
              </div>
            </div>
          ))}
        </div>
      ...
      <section id="collection" className="py-24 px-6 bg-gray-50">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <Link to="/collection/rise" className="text-xs font-black uppercase tracking-widest border-b-2 border-black pb-1 hover:opacity-50 transition-opacity">View All</Link>
          </div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="container mx-auto">
          ...
          <div className="text-center mt-12">
            <Link to="/journal" className="inline-block border-2 border-black px-10 py-4 font-bold text-xs uppercase tracking-widest hover:bg-black hover:text-white transition-all">
              View All Articles
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold uppercase tracking-widest">
              ...
              <li><Link to="/collection/rise" className="hover:text-gray-400 transition-colors">The Rise Collection</Link></li>
              <li><Link to="/gift-cards" className="hover:text-gray-400 transition-colors">Gift Cards</Link></li>
              <li><Link to="/journal" className="hover:text-gray-400 transition-colors">The Journal</Link></li>
            </ul>
          </div>
          <div>
